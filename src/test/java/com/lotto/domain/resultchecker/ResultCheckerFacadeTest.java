...
import com.lotto.domain.numbergenerator.WinningNumbersRepositoryTestImpl;
...
class ResultCheckerFacadeTest {
    ...
    public void it_should_generate_result_with_correct_credentials() {
        ...
        //then
        ResultDto expectedResults = ResultDto.builder()
                .hash(hash)
                .numbers(Set.of(7,8,9,10,11,12))
                .hitNumbers(Set.of())
                .drawDate(drawDate)
                .isWinner(false)
                .build();
        assertThat(resultDto).isEqualTo(expectedResults);
    }
}